...
with gr.Blocks(css='.narwal-logo img {height:500px; width:500px; margin:0 auto;}') as app:
    with gr.Row():
        logo_img=gr.Image('yunjing.png',elem_classes='narwal-logo')
    with gr.Row():
        chatbot=gr.Chatbot(label='通义千问1.8B-Chat-Int4')
    with gr.Row():
